...
#define VENGEANCE_HEALTH		40			// Health the user should have after using his ult
#define SHADOWSTRIKE_DAMAGE		10			// Amount of damage dealt with shadow strike
#define VENGEANCE_HEALTH_DELAY	5.0
...
WA_ULT_Vengeance( id )
{
	...
	{		
		...
		else
		{
			...
			set_task(VENGEANCE_HEALTH_DELAY, "ULT_Vegeance_SetUserHealth", id);
...
public ULT_Vegeance_SetUserHealth(id)
{
    // Check if the player is still connected before setting health
