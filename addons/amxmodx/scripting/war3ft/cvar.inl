...
public CVAR_Init()
{
	...
	CVAR_wc3_loot_items_health 		= register_cvar( "wc3_loot_items_health"	,"15"							);
	CVAR_wc3_loot_items_armor 		= register_cvar( "wc3_loot_items_armor"		,"25"							);
	CVAR_wc3_loot_remove			= register_cvar( "wc3_loot_remove"			,"1"							);
	CVAR_wc3_loot_stay 				= register_cvar( "wc3_loot_stay"			,"5"							);
