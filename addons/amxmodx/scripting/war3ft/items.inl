...
public SentSoundBuyFail(id) 
{ 
	if(is_user_connected(id))
	{
		emit_sound( id, CHAN_STATIC, g_szSounds[SOUND_ITEM_BUY_FAIL], 1.0, ATTN_NORM, 0, PITCH_NORM );
	}
}
...
ITEM_DisplayMessage( id, iItem )
{
	...
	switch ( iItem )
	{
		case ITEM_ANKH:
		{
			...
			(g_MOD == GAME_CSTRIKE || g_MOD == GAME_CZERO)	? client_print( id, print_chat,"%s %L : %L", g_MODclient, id, "ITEM_S_0", id, "INFO_SHOPMENU_1" ) : 0;
		}
		...
		case ITEM_BOOTS:
		{
			...
			{
				client_print( id, print_chat,"%s %L : %L", g_MODclient, id, "ITEM_S_1", id, "INFO_SHOPMENU_2");
			}
		...
		case ITEM_CLAWS:
		{
			client_print( id, print_chat,"%s %L : %L", g_MODclient, id, "ITEM_S_2", id, "INFO_SHOPMENU_3");
		}

		case ITEM_CLOAK:
		{
			client_print(id, print_chat,"%s %L : %L", g_MODclient, id, "ITEM_S_3", id, "INFO_SHOPMENU_4");
		}
		...
		case ITEM_MASK:
		{
			...
			client_print(id, print_chat,"%s %L : %L", g_MODclient, id, "ITEM_S_4", id, "INFO_SHOPMENU_5");
		}

		case ITEM_NECKLACE:
		{
			client_print( id, print_chat, "%s %L : %L", g_MODclient, id, "ITEM_S_5", id, "INFO_SHOPMENU_6");
		}

		case ITEM_FROST:
		{
			client_print(id, print_chat,"%s %L : %L", g_MODclient, id, "ITEM_S_6", id, "INFO_SHOPMENU_7");
		}

		case ITEM_HEALTH:
		{
			client_print(id, print_chat,"%s %L : %L", g_MODclient, id, "ITEM_S_7", id, "INFO_SHOPMENU_8");
		}
		...
		case ITEM_SCROLL:
		{
			if ( is_user_alive( id ) )
			{
				client_print( id, print_chat, "%s %L : %L", g_MODclient, id, "ITEM_S_9", id, "INFO_SHOPMENU2_1" );
			}

			else
			{
				client_print( id, print_chat, "%s %L : %L", g_MODclient, id, "ITEM_S_9", id, "INFO_SHOPMENU2_1_DEAD" );
			}
		}

		case ITEM_PROTECTANT:
		{
			client_print( id, print_chat, "%s %L : %L", g_MODclient, id, "ITEM_S_10", id, "INFO_SHOPMENU2_2" );
		}

		case ITEM_HELM:
		{
			client_print( id, print_chat, "%s %L : %L", g_MODclient, id, "ITEM_S_11", id, "INFO_SHOPMENU2_3");
		}

		case ITEM_AMULET:
		{
			client_print( id, print_chat, "%s %L : %L", g_MODclient, id, "ITEM_S_12", id, "INFO_SHOPMENU2_4" );
		}

		case ITEM_SOCK:
		{
			client_print( id, print_chat, "%s %L : %L", g_MODclient, id, "ITEM_S_13", id, "INFO_SHOPMENU2_5" );
		}

		case ITEM_GLOVES:
		{
			client_print( id, print_chat, "%s %L : %L", g_MODclient, id, "ITEM_S_14", id, "INFO_SHOPMENU2_6");
		}

		case ITEM_RING:
		{
			client_print( id, print_chat, "%s %L : %L", g_MODclient, id, "ITEM_S_15", id, "INFO_SHOPMENU2_7" );
		}

		case ITEM_CHAMELEON:
		{
			client_print( id, print_chat, "%s %L : %L", g_MODclient, id, "ITEM_S_16", id, "INFO_SHOPMENU2_8" );
		}

		case ITEM_MOLE:
		{
			client_print( id, print_chat, "%s %L : %L", g_MODclient, id, "ITEM_S_17", id, "INFO_SHOPMENU2_9" );
		}
...
ITEM_Tome( id )
{
	...
	if ( iBonusXP != 0 )
	{
		client_print( id, print_chat, "%s %L : %L %d XP", g_MODclient, id, "ITEM_S_8", id, "INFO_SHOPMENU_9", iBonusXP );
